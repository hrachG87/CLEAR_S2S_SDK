...
public class AdditionalInfo
{
    ...
    [XmlElement("PersonIdentificationDetails")]
    public string PersonIdentificationDetails { get; set; }
    ...
    [XmlElement("DateOfPublicationOfTheList")]
    public string DateOfPublicationOfTheList { get; set; }

    [XmlElement("NameOfTheList")]
    public string NameOfTheList { get; set; }

    [XmlElement("PasssportNr")]
    public string PasssportNr { get; set; }

    [XmlElement("Authority")]
    public string Authority { get; set; }

    [XmlElement("CaseDescr")]
    ...
    [XmlElement("RegimeTypeUkUn")]
    public string RegimeTypeUkUn { get; set; }

    [XmlElement("Position")]
    public string Position { get; set; }

    [XmlElement("HonoraryProfessionalReligiousTitles")]
    public string HonoraryProfessionalReligiousTitles { get; set; }
    ...
    [XmlElement("AffiliationGDCId")]
    public string AffiliationGDCId { get; set; }
