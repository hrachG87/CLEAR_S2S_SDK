...
public class CriminalFlags
{
    ...
    public AnimalCruelty AnimalCruelty { get; set; }
    ...
    public CommercialSexOffenses CommercialSexOffenses { get; set; }
    ...
    public SexOffenses SexOffenses { get; set; }
    ...
    [XmlElement("Abortion")]
    public Abortion Abortion { get; set; }
    ...
    public AbuseOfCorpse AbuseOfCorpse { get; set; }
