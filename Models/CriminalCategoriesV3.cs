...
[XmlRoot("CriminalCategoriesV3")]
public class CriminalCategoriesV3
{
    ...
    public CriminalCategoryAnimalCrueltyV3 AnimalCruelty { get; set; }
    ...
    public CriminalCategoryCommercialSexOffenseV3 CommercialSexOffense { get; set; }
    ...
    public CriminalCategoryFamilyOffensesV3 FamilyOffenses { get; set; }
    ...
    public CriminalCategorySexOffensesV3 SexOffenses { get; set; }
