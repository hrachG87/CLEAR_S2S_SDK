...
[XmlRoot("PersonQuickAnalysisRiskFlags")]
public class PersonQuickAnalysisRiskFlags
{
    ...
    public bool CriminalLowLevelTrafficOffense { get; set; }

    [XmlElement("SexOffender")]
    public bool SexOffender { get; set; }

    [XmlElement("CriminalUncategorized")]
    public bool CriminalUncategorized { get; set; }
